...
namespace Taurinorum.Object.FilterModel
{
    public class TimbraFM : BaseFM
    {
        ...
        public override string ToXml()
        {
            ...
            xml += Utils.CreateXmlTag("Longitudine", Utils.ConvertiDecimal(Longitudine));
            xml += Utils.CreateXmlTag("Latitudine", Utils.ConvertiDecimal(Latitudine));
